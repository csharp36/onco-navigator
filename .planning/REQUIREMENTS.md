...
- [ ] **PATH-01**: System maintains configurable pathway templates defining the correct sequence of events for each cancer type, with step names, types, prerequisites, time windows, and suggested corrective actions
- [ ] **PATH-02**: System includes pathway templates for breast cancer (Stage I-III), lung cancer (Stage I-III), and colorectal cancer (Stage I-III) as defined in the clinical specification
...
- [ ] **PATH-08**: Physician can annotate a deliberate step reordering to suppress false-positive alerts for that patient's pathway
